...
int main(int argc, char *argv[])
{
    ...
    //read input file
    auto iplist = std::ifstream(file_in);
    ...
    auto root_node1 = PList::Structure::FromXml(plist_xml);
    if (!root_node1)
    {
    ...
    auto plist_xml2 = root_node2->ToXml();
    if (plist_xml2.empty())
    {
    ...
    {
        auto oplist = std::ofstream(file_out);
        oplist << plist_xml2;
    }
